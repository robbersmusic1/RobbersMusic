...
async def song(client, message):
    ...
    if not video_link:
        await status.edit("✖️ Bulunamadı Şarkı. Üzgünüm.\n\nDenemek başka bir anahtar Başka bir Anahtar İşi Veya Belki büyü o uygun.\n\nOrnek.`/song Şarkı İsmi`")
        return ""
    ...
    try:
        ...
        await status.edit("Şarkı İndirilemedi😶")
        LOGGER.error(ex)
        return ""
